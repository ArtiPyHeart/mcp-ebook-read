...
class ErrorCode(StrEnum):
    ...
    INGEST_PDF_FAST_PARSE_FAILED = "INGEST_PDF_FAST_PARSE_FAILED"
    INGEST_PDF_DOCLING_FAILED = "INGEST_PDF_DOCLING_FAILED"
    INGEST_PDF_DOCLING_TIMEOUT = "INGEST_PDF_DOCLING_TIMEOUT"
    INGEST_PDF_FORMULA_ENGINE_UNAVAILABLE = "INGEST_PDF_FORMULA_ENGINE_UNAVAILABLE"
    INGEST_GRAPH_VALIDATION_FAILED = "INGEST_GRAPH_VALIDATION_FAILED"
    ...
    READ_FORMULA_NOT_FOUND = "READ_FORMULA_NOT_FOUND"
    READ_TABLE_NOT_FOUND = "READ_TABLE_NOT_FOUND"
    READ_FIGURE_NOT_FOUND = "READ_FIGURE_NOT_FOUND"
